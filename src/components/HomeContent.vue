    ...
    <div>
        ...
        <div class="row mt-5">
            <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12 col-xs-12">
                ...
                <div class="home-tour-group">
                    <div class="row">
                        <div class="col-md-3 home-objects" v-for="accommodation in homeAccommodations"
...
export default {
    name: 'HomeContent',
    async setup() {
        const apiURL = "http://shine.test:8000/uploads/";
        const siteURL = "http://shine.test:8000/";
        const [{ data: homeTours }, { data: homeAccommodations }] =
            await Promise.all([
                useFetch("http://shine.test:8000/api/bc_tours"),
                useFetch("http://shine.test:8000/api/bc_spaces"),
            ]);
        return {
            homeTours,
            homeAccommodations,
