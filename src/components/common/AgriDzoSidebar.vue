                ...
                <div class="accordion-body">
                    <div class="c">
                        <div class="sidebar-filters">
                            ...
                            <div class="heading">
                                <h6 class="mb-3" style="line-height:1.6rem">Agri Products from other Dzongkhags</h6>
                            </div>
                             <div v-for="dzongkhag in categories" :key="dzongkhag.name">
                                <ul class="agri-list">
                                    <RouterLink :to="'/agri-dzo-filter/' + dzongkhag.slug" :class="{ active: isActive }">
                                        <li>{{dzongkhag.name}}</li>
                                    </RouterLink>
                                </ul>
                             </div>
                            <div class="back-to-home">
                                <RouterLink to="/agriproducts" class="return-link">
