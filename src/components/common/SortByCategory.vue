        ...
        >
          <div class="card mt-2">
            ...
            >
              <div class="card-body">
                <img
                  v-if="category.name === 'City trips'"
                  loading="lazy"
                  :src="'assets/img/city_trips.jpg'"
                  alt=""
                  class="card-img img-fluid"
                />
                <img
                  v-if="category.name === 'Ecotourism'"
                  loading="lazy"
                  :src="'assets/img/eco_tourism.jpeg'"
                  alt=""
                  class="card-img img-fluid"
                />
                <img
                  v-if="category.name === 'Escorted tour'"
                  loading="lazy"
                  :src="'assets/img/escorted_tour.jpeg'"
                  alt=""
                  class="card-img img-fluid"
                />
                <img
                  v-if="category.name === 'Food and Festivals'"
                  loading="lazy"
                  :src="'assets/img/food_festival.jpeg'"
                  alt=""
                  class="card-img img-fluid"
                />
                <img
                  v-if="category.name === 'Nature & Adventure'"
                  loading="lazy"
                  :src="'assets/img/nature_adv.jpeg'"
                  alt=""
                  class="card-img img-fluid"
                />
                <img
                  v-if="category.name === 'Culture & Society'"
                  loading="lazy"
                  :src="'assets/img/culture_society.jpeg'"
                  alt=""
                  class="card-img img-fluid"
                />
                <img
                  v-if="category.name === 'Agriculture & Livelyhood'"
                  loading="lazy"
                  :src="'assets/img/agri_tour.jpeg'"
                  alt=""
                  class="card-img img-fluid"
                />
                <div class="card-details">
