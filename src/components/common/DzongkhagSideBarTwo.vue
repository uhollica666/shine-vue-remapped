                ...
                <div class="accordion-body">
                    <div class="c">
                        <div class="sidebar-filters">
                            ...
                            <div class="dzo-list" v-for="dzongkhag in dzongkhags" :key="dzongkhag.name">
                                <RouterLink :to="{name:'AccommodationDzongkhags', params:{slug: dzongkhag.slug}}" :class="{active: isActive }">
                                    <ul class="lists-dzo">
