...
export default {
    ...
    async setup() {
        ...
        const bc_tours = await fetch("http://shine.test/api/bc_tours");
        const bc_accommodations = await fetch("http://shine.test/api/bc_spaces");
        const bc_dzongkhagDetails = await fetch("http://shine.test/api/bc_locations");
