  ...
  methods: {
    async login() {
      ...
      if (loginNow.data.token_type) {
        ...
        this.$router.push("/ecom-vendor-login");
      } else {
...
.login-bg {
  background: url(https://images.pexels.com/photos/8056760/pexels-photo-8056760.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1) no-repeat center center fixed;
