  ...
  <div class="container-fluid my-5">
    <div v-for="product in products" :key="product.id">
        ...
        <div class="col-md-5 d-flex">
            <img :src="siteURL + 'public/'+product.file_name" :alt="product.name" class="img-fluid img-prod" loading="lazy">
        </div>
        <div class="col-md-7 py-5">
            <section class="row">
                ...
                <div class="col-md-6" v-if="!product.rating">
                    <i class="bi bi-star-fill text-warning prod-descrip"></i> Product Rating: <em><b class="mx-1">No Ratings Yet!</b></em>
                </div>
                <div class="col-md-6" v-else>
                    <i class="bi bi-star-fill text-warning prod-descrip"></i> Product Rating: {{product.rating}}
                </div>
                <div class="col-md-6">
            ...
            <section class="row">
                ...
                <div class="col-md-12 prod-descrip" v-else>
                    <h4>Nu. {{product.unit_price}}.00 <span>per killogram</span></h4> 
                </div>
            </section>
            <div class="hr my-4"></div>
            <section class="row">
            ...
            <section class="row">
                <a :href="siteURL + 'product/' + product.slug" target="_blank">
                    <button class="btn-buy"><i class="bi bi-eye"></i>Proceed to Buy</button>
                </a>
