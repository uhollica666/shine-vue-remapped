  ...
  <div class="container-fluid my-5">
    <div v-for="property in properties" :key="property.id">
      <div class="property-card px-5">
        <section class="row">
          <img :src="siteURL + 'uploads/' + property.file_path" :alt="property.title" class="img-fluid img-prop col-md-12"
            loading="lazy" />
        </section>
        <section class="row mt-3">
          ...
          <div v-if="property.sale_price" class="col-md-6 prod-descrip my-3">
            ...
            <h5>
              ...
              {{ property.sale_price }} per Night
            </h5>
          </div>
          <div v-else class="col-md-6 prod-descrip my-3">
            <h5>Nu. {{ property.price }} per Night</h5>
          </div>
        </section>
        ...
        <section class="row my-3">
          <div class="row">
            <div class="col-md-4" v-if="!property.rating">
              ...
              <em><b class="mx-1">No Ratings Yet!</b></em>
            </div>
